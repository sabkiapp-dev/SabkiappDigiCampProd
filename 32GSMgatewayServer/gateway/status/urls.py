...
from .views import (
    gateway_status, receive_sms, send_sms, sms_response,
    ...
    gsm_info_view, authenticate,
)

urlpatterns = [
    path('gateway_status', gateway_status, name='gateway_status'),
    ...
    path('Documents/32GSMgatewayServer.zip', download_zip, name='download_zip'),
