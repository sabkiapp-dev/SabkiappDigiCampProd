...
# "…/DigiCampServer/digicamp" is the folder that contains manage.py *and*
# the actual Django package (digicamp_server/__init__.py, settings.py, …).
MANAGE_DIR = pathlib.Path(__file__).resolve().parents[1] / "digicamp"
