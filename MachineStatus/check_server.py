...
# Fix import paths
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'machine_status'))
...
def run_script():
    result = os.system("python /home/pi/Documents/MachineStatus/ami_listener.py")
    if result == 0:
...
def start_run_server_django():
    import subprocess
    subprocess.Popen(['/bin/bash', '/home/pi/Documents/MachineStatus/run_server.sh', 'django'])
    ...
    while True:
        ...
        try:
            ...
            if not django_ok:
                ...
                is_ami_listener_running = check_script_status('/home/pi/Documents/MachineStatus/ami_listener.py')
