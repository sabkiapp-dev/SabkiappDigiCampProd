# MachineStatus — Architectural Documentation

## Abstract

MachineStatus is a remote monitoring and management system for a multi-SIM VoIP GSM gateway deployed on a Raspberry Pi. It exposes a REST API for centralized control of SIM cards, SMS, voice calls, and USSD operations across multiple cellular ports, enabling a remote VPS server to query and manage the gateway.
...
│  ┌──────────────────────────────────────────────────────────┐   │
│  │               Business Logic (src/)                      │   │
│  │  MachineStatus · PortData · VoipGatewayClient · SMS ·    │   │
...
|---|---|---|
| `/machine_status` | GET | Full port status, SIM states, SMS balances |
...
| `/Documents/MachineStatus.zip` | GET | Download packaged zip |

---

## Key Components

### `src/machine_status.py` — Status Aggregator
...
- **Target path**: `/home/pi/Documents/MachineStatus` (hardcoded throughout)
